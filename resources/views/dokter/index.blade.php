<x-app-layout>
    ...
    <div class="container mx-auto p-4 py-12">
        ...
        <a href="#"
            class="block max-w-screen-xl p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Welcome, Dr.
                {{ $dokter->nama }}</h5>
        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
            <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Your Konsultasi Requests</h2>
            @if ($konsultasis->isEmpty())
                <p class=>No konsultasi requests yet.</p>
            @else
